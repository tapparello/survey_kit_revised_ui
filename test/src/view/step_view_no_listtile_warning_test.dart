  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        isNull,
        reason:
            'single-choice render must not emit the ListTile ink/background warning',
      );
      ...
      expect(
        ...
        isTrue,
        reason:
            'answer rows must be wrapped in a Theme that disables ink (no ripple)',
      );
