...
void main() {
  group('TemplateResolver', () {
    test('resolves simple string placeholder', () {
      final result = TemplateResolver.resolve('Hello {{name}}!', {
        'name': 'World',
      });
    ...
    test('resolves multiple placeholders', () {
      final result = TemplateResolver.resolve('{{greeting}} {{name}}!', {
        'greeting': 'Hi',
        'name': 'Alice',
      });
    ...
    test('resolves list placeholder as li items', () {
      final result = TemplateResolver.resolve('<ul>{{#list items}}</ul>', {
        'items': ['Apple', 'Banana'],
      });
    ...
    test('replaces unresolved placeholder with empty string', () {
      final result = TemplateResolver.resolve('Hello {{missing}}!', {});
      expect(result, 'Hello !');
    });
    ...
    test('resolves list placeholder with single item', () {
      final result = TemplateResolver.resolve('{{#list items}}', {
        'items': ['Only'],
      });
